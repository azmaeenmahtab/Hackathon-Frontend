...
const EventCard = ({ icon, type, title, status, description, date, onButtonClick, buttonLabel }) => {
  // derive color based on status
  let statusColor = "text-green-600"; // default: upcoming/active
  if (status === "Cancelled") statusColor = "text-red-600";
  else if (status === "Registered") statusColor = "text-blue-600";
